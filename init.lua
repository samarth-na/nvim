...
require('lazy').setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
        ...
        config = function()
            ...
            vim.keymap.set('n', '<leader>jj', builtin.jumplist, { desc = '[ ] find in jumplist' })
            vim.keymap.set('n', '<leader>jq', builtin.quickfix, { desc = '[ ] find in jumplist' })
            vim.keymap.set('n', '<leader>js', builtin.treesitter, { desc = '[s]ymbol  in the buffer' })
            vim.keymap.set('n', '<leader>ss', builtin.live_grep, { desc = '[s]earch by [g]rep' })
            vim.keymap.set('n', '<leader>sq', builtin.quickfix, { desc = '[ ] find in jumplist' })
